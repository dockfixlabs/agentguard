...
**Tool:** AgentGuard v0.8.0 | **Date:** 2026-07-08 19:40 UTC
**Target:** `../qwen-agent` | **Files scanned:** 238
**Scan duration:** 15008ms
...
| LIKELY_FP | 128 | Probable false positive |
...
| Prompt Template Injection | 3 | HIGH |
...
| ..\qwen-agent\qwen_agent\tools\mcp_manager.py | 4 |
...
*... and 172 more critical/high findings*
